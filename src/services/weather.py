...
class WeatherService:
    __weather_access_key = "1f1e1cfa-2644-48ff-902d-2f71aa0d9477"
    __geocoder_api_key = "pk.3eefeb00697e051f63652e977e277866"

    def get_coordinates_by_city_name(self, city_name: str) -> dict | None:
        url = f"https://us1.locationiq.com/v1/search.php"

        params = {
            'key': self.__geocoder_api_key,
            'q': city_name,
            'format': 'json',
            'limit': 1
        }
    ...
    def get_weather_forecast_by_lat_lon(self, lat: float, lon: float, days: int = 7) -> dict | None:
        url = "https://api.weather.yandex.ru/v2/forecast"

        headers = {
            'X-Yandex-Weather-Key': self.__weather_access_key
        }
    ...
    def get_weather_details(self, weather_row_data: dict) -> dict:
        result = {
            "daily_forecast": []
        }
